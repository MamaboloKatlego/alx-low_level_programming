 ...
 * @e_ident: The pointyer to an array containing the ELF magic numerals.
 *
 * Description: Exit code 98 if the is not an ELF file.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: The pointer to an array containing the ELF magic numerals.
 *
 ...
 * @e_ident: the pointer to an array containing the ELF header.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
...
/**
 * print_entry - It prints the entry pointer of an ELF header.
 ...
 *
 * Description: Exit code 98 if the file cannot bo closed.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * Return: On success 0.
 *
 * Description: Exit code 98 if the function fails or
